...
struct Album {
    ...
    var coverArt: String = "" // keyed Container has "url" property as a Keyed container Value
...
extension Album: Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        while !coverArtUnkeyedContainer.isAtEnd {
            ...
            let coverArtURL: URL = try coverArtContainer.decode(URL.self, forKey: .url)
            coverArt = coverArtURL.absoluteString
        }
