...
class AlbumDetailTableViewController: UITableViewController {
    ...
    */
    ...
    @IBOutlet weak var newAlbumArtist: UITextField!
    
    @IBOutlet weak var newAlbumGenres: UITextField!
    
    @IBOutlet weak var newAlbumCoverURLs: UITextField!
    
    
    @IBAction func saveNewAlbum(_ sender: UIBarButtonItem) {
